<template>
  <div class="weekDays-selector">
    ...
    <input
      ...
      id="weekday-sun"
      class="weekday"
      v-model="dayStatus[6].isActive"
      v-on:click="changeStatus(6)"
    />
...
export default {
  data() {
    return {
      dayStatus: this.$store.getters.getDaysStatuses
    };
  },
  methods: {
    changeStatus(num) {
